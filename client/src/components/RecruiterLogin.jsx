    ...
    return (
        <div className='absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                {state === "Sign Up" && isTextDataSubmitted
                    ...
                    <>
                        ...
                        <div className='border px-4 py-2 flex items-center gap-2 rounded-full mt-5'>
                            ...
                            <input className='outline-none text-sm' type="email" placeholder='E-mail' required onChange={(e) => setEmail(e.target.value)} value={email} />
                        </div>
                ...
                {state === "Login" && <p className='text-sm text-purple-600 cursor-pointer mt-4'>Forgot password?</p>
                }

                <button type='submit' className='w-full bg-purple-600 text-white py-2 rounded-full mt-5'>
